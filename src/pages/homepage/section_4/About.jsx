...
const About = () => {
  return (
    <div className="min-h-screen bg-[#FBF7F3]">
      <div className="md:flex gap-10 max-w-6xl mx-auto font-poppins">
        <div className="left md:w-5/12">
          <p className="mt-8">(2)About:</p>
          <h1 className="text-right text-4xl mb-14">About Us</h1>
          <img src={aboutImage2} alt="" className="w-80" />
        </div>
        <div className="right md:w-7/12">
          <img src={aboutImage1} alt="" className="w-11/12" />
          <p className="text-[#999] w-10/12 mt-2">
